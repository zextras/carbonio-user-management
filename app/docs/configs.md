...
| `carbonio.postgresql.host` | `127.78.0.5` |
...
Keep in mind that some configs (mainly database credentials) without a default are always populated by the setup operation.
